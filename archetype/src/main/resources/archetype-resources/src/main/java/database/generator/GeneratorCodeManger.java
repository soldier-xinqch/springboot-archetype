...
public class GeneratorCodeManger {
    ...
    //文件生成地址
    private static File file = new File("G:${symbol_escape}${symbol_escape}workspace${symbol_escape}${symbol_escape}ownSpace${symbol_escape}${symbol_escape}${artifactId}${symbol_escape}${symbol_escape}");
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("${groupId}."+packageName)// 自定义包路径
