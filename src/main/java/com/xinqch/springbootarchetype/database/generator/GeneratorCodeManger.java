package com.xinqch.springbootarchetype.database.generator;
...
public class GeneratorCodeManger {
    ...
    //文件生成地址
    private static File file = new File("G:\\workspace\\ownSpace\\springboot-archetype\\");
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("com.xinqch."+packageName)// 自定义包路径
